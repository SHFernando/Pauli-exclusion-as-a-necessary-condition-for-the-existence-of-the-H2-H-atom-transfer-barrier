...
def stacked_3x3_amp():
    ...
    ax3.plot(0, 1, transform=ax3.transAxes, **kwargs)
    ax1.set_ylabel(r'${\phi}_3$',fontsize=20,labelpad=20)
    ax2.set_ylabel(r'${\phi}_2$',fontsize=20,labelpad=20)
    ax3.set_ylabel(r'${\phi}_1$',fontsize=20,labelpad=20)
    ax3.set_xlabel(r'z $\,/\,\mathrm{\AA}$',fontsize=20)
    ax6.set_xlabel(r'z $\,/\,\mathrm{\AA}$',fontsize=20)
    ax9.set_xlabel(r'z $\,/\,\mathrm{\AA}$',fontsize=20)
    ax3.tick_params(which='major', labelsize=18)
    ax6.tick_params(which='major', labelsize=18)
    ax9.tick_params(which='major', labelsize=18)
    ax2.tick_params(which='major', labelsize=18)
    ax1.tick_params(which='major', labelsize=18)
    ...
    for plt_no,ax in enumerate(axes):
        if plt_no > 5:
            ...
            ax.plot(atom_pos_2[0],0,linestyle='',color='tab:blue',marker='.',markersize=16)
            ax.plot(atom_pos_2[1],0,linestyle='',color='tab:blue',marker='.',markersize=16)
            ax.plot(atom_pos_2[2],0,linestyle='',color='tab:blue',marker='.',markersize=16)
            ...
            for pos in atom_pos_1:
                ax.axvline(x=pos,linestyle='--',linewidth=2.0,color=(0,0,0),alpha=0.5)
            ax.axhline(y=0.0,linestyle='--',linewidth=1.4,color='k')
            ax.plot(atom_pos_1[0],0,linestyle='',color='tab:blue',marker='.',markersize=16)
            ax.plot(atom_pos_1[1],0,linestyle='',color='tab:blue',marker='.',markersize=16)
            ax.plot(atom_pos_1[2],0,linestyle='',color='tab:blue',marker='.',markersize=16)
            ax.yaxis.set_major_locator(ticker.MultipleLocator(0.2))
            ax.xaxis.set_major_locator(ticker.MultipleLocator(1))
        else:
            for pos in atom_pos:
                ax.axvline(x=pos,linestyle='--',linewidth=2.0,color=(0,0,0),alpha=0.5)
            ax.axhline(y=0.0,linestyle='--',linewidth=1.4,color='k')
            ax.plot(atom_pos[0],0,linestyle='',color='tab:blue',marker='.',markersize=16)
            ax.plot(atom_pos[1],0,linestyle='',color='tab:blue',marker='.',markersize=16)
            ax.plot(atom_pos[2],0,linestyle='',color='tab:blue',marker='.',markersize=16)
            ax.yaxis.set_major_locator(ticker.MultipleLocator(0.2))
            ax.xaxis.set_major_locator(ticker.MultipleLocator(1))

    #ax1.text(-3.5,0.3,r'$T=1.448\,$Ha',fontsize=15)
    ax2.text(-3.5,0.3,r'$T=0.563\,$Ha',fontsize=15)
    ax3.text(-3.5,0.3,r'$T=0.505\,$Ha',fontsize=15)
    #ax4.text(-3.5,0.3,r'$T=1.517\,$Ha',fontsize=15)
    ax5.text(-3.5,0.3,r'$T=0.556\,$Ha',fontsize=15)
    ax6.text(-3.5,0.3,r'$T=0.549\,$Ha',fontsize=15)
    #ax7.text(-3.5,0.3,r'$T=1.419\,$Ha',fontsize=15)
    ax8.text(-3.5,0.3,r'$T=0.627\,$Ha',fontsize=15)
    ax9.text(-3.5,0.3,r'$T=0.479\,$Ha',fontsize=15)
    ax1.set_title(r'$r_1-r_2=−1.74\,\mathrm{\AA}$',pad=14,fontsize=18)
    ax4.set_title(r'$r_1-r_2=−0.71\,\mathrm{\AA}$',pad=14,fontsize=18)
    ax7.set_title(r'$r_1-r_2=0.0\,\mathrm{\AA}$',pad=14,fontsize=18)
